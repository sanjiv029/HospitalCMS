    ...
    <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="date_of_birth_bs"  class="form-control nepali-datepicker @error('date_of_birth_bs') is-invalid @enderror" value="{{ old('date_of_birth_bs', $doctor->date_of_birth_bs ?? '') }}" placeholder="YYYY-MM-DD">
                        <input type="hidden" name="date_of_birth_ad" id="date_of_birth_ad" class="form-control ad-date @error('date_of_birth_ad') is-invalid @enderror" value="{{ old('date_of_birth_ad', $doctor->date_of_birth ?? '') }}">
                    </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select name="gender" id="gender" class="form-control @error('gender') is-invalid @enderror" required>
                            ...
                            <option value="other" {{ old('gender', $doctor->ggender ?? '') == 'other' ? 'selected' : '' }}>Other</option>
                        </select>
                    </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select name="marital_status" id="marital_status" class="form-control @error('marital_status') is-invalid @enderror" required>
                            ...
                            <option value="divorced" {{ old('marital_status', $doctor->gmarital_status ?? '') == 'divorced' ? 'selected' : '' }}>Divorced</option>
                            <option value="widowed" {{ old('marital_status', $doctor->gmarital_status ?? '') == 'widowed' ? 'selected' : '' }}>Widowed</option>
                        </select>
                    </div>
        ...
        <div class="step" id="step3" style="display:none;">
            ...
            <div class="row" id="education-fields">
                <div class="col-md-12 experience-item">
                    <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
            ...
            <div class="d-flex justify-content-between mt-4">
                ...
                <button type="button" class="btn btn-success add-repeater-row" id="add-education"><i class="fas fa-plus"></i> Add Education</button>
        ...
        <div class="step" id="step4" style="display:none;">
            ...
            <div class="d-flex justify-content-between mt-4">
                ...
                <button type="button" id="add-experience" class="btn btn-success add-repeater-row">Add Experience</button>
